...
const ContactList = ({contacts, isChannel = false}) => {
  ...
  return (
    ...
    <div key={contact._id} className={`pl-10 py-2 transition-all duration-300 cursor-pointer ${selectedChatData && selectedChatData._id === contact._id? "bg-[#fd4949] hover:bg-[#c63434]":"hover:bg-[#f1f1f111]"}`}
