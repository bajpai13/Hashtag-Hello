...
const Profile = () => {
  ...
  return (
    <div className='bg-[#111113] h-[100vh] flex items-center justify-center flex-col gap-10'>
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
      <div onClick={handleNavigate} className='flex items-start gap-8'>
      <IoArrowBack className='text-2xl lg:text-4xl text-white/90 cursor-pointer'/>
      <div className='flex-1 text-center'>
           <h3 className='text-white text-3xl mb-8'>Setup Your Profile</h3>
       </div>
    </div>
        ...
        <div className="w-full">
          <Button className="h-16 w-full bg-red-600 hover:bg-red-800 transition-all duration-300" onClick={saveChanges}>
            Save Changes 
          </Button>
        </div>
      </div>
