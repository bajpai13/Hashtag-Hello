...
const CreateChannel = () => {
  ...
  <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
    <DialogHeader>
      <DialogTitle>Edit details for new channel.</DialogTitle>
      <DialogDescription>
    ...
    <div>
        ...
        emptyIndicator={
            <p className="text-center text-lg leading-10 to-gray-600">
                No Results Found.
            </p>
        }
        />
    ...
    <div>
        <Button className="w-full bg-red-600 hover:bg-red-900 transition-all duration-300"
